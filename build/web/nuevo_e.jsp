...
<html>
    ...
    <body class="bg-dark ">
        <div class="container-sm w-25 mt-5">
            <h1 class="text-light">Nueva Editorial</h1>
            <form action="MiServlet1" method="post">
                <label for="txt_nombre" class="form-label text-light mt-3 ">Nombre de la Editorial:</label>
                <input type="text" name="txt_nombre" id="txt_nombre" class="form-control" 
                       pattern="[a-zA-Z\s]+" title="Solo se permiten letras y espacios" required/>
                <label for="txt_pais" class="form-label text-light mt-3">País:</label>
